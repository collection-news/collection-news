...
export const DatePicker = ({ onSelect, range: [firstDay, lastDay] }: DatePickerProps) => {
  ...
  const _onSelect: OnSelectHandler<Date | undefined> = (day, selectedDay, modifiers, e) => {
  ...
  return (
    ...
    >
      ...
      <Popover.Positioner>
        <Popover.Content borderRadius="sm" borderWidth="1px" fontSize="md" lineHeight={1.5} boxShadow="popover">
          <DayPicker
            selected={selected}
            onSelect={_onSelect}
